...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <ul class=${variables.socialMediaPosition}>
            <li><a href="${variables.twitter}">${twitterIcon}</a></li>
            <li><a href="${variables.github}">${githubIcon}</a></li>
            <li><a href="${variables.linkedin}">${linkedinIcon}</a></li>
            <li><a href="${variables.instagram}">${instagramIcon}</a></li>
          </ul>
        </div>
    `;
}
